    ...
    public partial class Sync : Form
    {
...

        {
...

            {
                ...
                string sourceConnectionString = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\\HIS.mdf;Integrated Security=True";
                string targetConnectionString = "server=mysql5026.site4now.net;database=db_a9cd22_abdojkl;uid=a9cd22_abdojkl;password=a1234567;SslMode=None";
                ...
                try
                {
                    ...
                    using (SqlConnection sourceConnection = new SqlConnection(sourceConnectionString))
                    {
                        ...
                        using (SqlCommand command = new SqlCommand(query1, sourceConnection))
                        {
                        ...
                        //////////////////////////////////////////////////
                        using (SqlCommand command = new SqlCommand(query2, sourceConnection))
                        {
                            using (SqlDataReader reader = command.ExecuteReader())
                            {
                                // Establish connection to target database
                    ...
                    using (SqlConnection sourceConnection = new SqlConnection(sourceConnectionString))
                    {
                        ...
                        using (SqlCommand insertCommand2 = new SqlCommand(insertQuery2, sourceConnection))
                        {
