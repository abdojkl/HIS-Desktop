...

{
			...
			public Referral(Color themeColor,PatientRecordManagement.Models.Visit record = null, bool readOnly = false)
			{
			...
			if (BeforeSave != null)
                 if (!BeforeSave.Invoke(_oldRecord, _record))
                        return;
                _record.Type_of_service = "Referral";
