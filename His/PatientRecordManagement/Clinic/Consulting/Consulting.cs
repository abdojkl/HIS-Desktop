...

{
			...
			public Consulting(Color themeColor,PatientRecordManagement.Models.Visit record = null, bool readOnly = false)
			{
...
//reference
           ...
           //  JengaInit(themeColor);
			...
			if (BeforeSave != null)
                ...
                _record.Type_of_service = "Consulting";
        ...
        private void labelA7_Click(object sender, EventArgs e)
        {
