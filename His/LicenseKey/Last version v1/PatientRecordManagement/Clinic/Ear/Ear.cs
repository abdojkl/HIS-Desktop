...

{
        ...
        public Ear(Color themeColor,PatientRecordManagement.Models.Visit record = null, bool readOnly = false)
			{
			...
			var db = Kt.Db;
            bunifuDropdown1.DataSource=db.Select<PatientRecordManagement.Models.Doctor>();
//reference
			...
			if (BeforeSave != null)
                ...
                _record.Type_of_service = "Ear Clinic";
        ...
        private void bunifuDropdownA2_SelectedIndexChanged(object sender, EventArgs e)
        {
