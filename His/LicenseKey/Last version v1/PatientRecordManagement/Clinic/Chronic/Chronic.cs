...

{
        ...
        public Chronic(Color themeColor,PatientRecordManagement.Models.Visit record = null, bool readOnly = false)
			{
			...
			var db = Kt.Db;
            bunifuDropdown2.DataSource=db.Select<PatientRecordManagement.Models.Doctor>();
//reference
			...
			if (BeforeSave != null)
                 if (!BeforeSave.Invoke(_oldRecord, _record))
                        return;
                _record.Type_of_service = "Chronic Clinic";
