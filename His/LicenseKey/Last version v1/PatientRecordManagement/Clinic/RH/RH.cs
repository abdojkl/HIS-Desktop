...

{
			...
			public RH (Color themeColor,PatientRecordManagement.Models.Visit record = null, bool readOnly = false)
			{
...
//reference
			...
			if (BeforeSave != null)
                ...
                _record.Type_of_service = "RH Clinic";
