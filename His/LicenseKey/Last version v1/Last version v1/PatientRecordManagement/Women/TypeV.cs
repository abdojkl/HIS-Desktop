//Code Generated by Jenga.NET
			...
			public partial class TypeV : Form
			{
			...
			public TypeV (Color themeColor,PatientRecordManagement.Models.Visit record = null, bool readOnly = false)
			{
			...
			var db = Kt.Db;
			bunifuDropdownT1.DataSource=db.Select<PatientRecordManagement.Models.Doctor>();
//reference
