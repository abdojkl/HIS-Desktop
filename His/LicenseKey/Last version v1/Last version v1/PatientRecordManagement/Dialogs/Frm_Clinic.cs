//Code Generated by Jenga.NET
			...
			public partial class Frm_Clinic: Form
			{
			private PatientRecordManagement.Models.Clinic _record;
			private PatientRecordManagement.Models.Clinic _oldRecord;
            public Dictionary<string, object> FixedValues = new Dictionary<string, object>();

            public Func<PatientRecordManagement.Models.Clinic, PatientRecordManagement.Models.Clinic, bool> BeforeSave { get; set; } = null;
            public Action<PatientRecordManagement.Models.Clinic> AfterSave { get; set; } = null;

			public Frm_Clinic(Color themeColor,PatientRecordManagement.Models.Clinic record = null, bool readOnly = false)
			{
			...
			if(record==null)
			_record = new PatientRecordManagement.Models.Clinic(); //create new recoded
			else
            ...
            catch (Exception err)
            {
			  ...
			  private void Frm_Load(object sender, EventArgs e) 
			  {
					...
					if (this.FixedValues.Count() > 0)
					{
						...
						_record = tmp.ToObject<PatientRecordManagement.Models.Clinic>();
					}
