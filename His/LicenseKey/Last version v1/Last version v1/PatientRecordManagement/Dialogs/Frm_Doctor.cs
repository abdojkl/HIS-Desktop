//Code Generated by Jenga.NET
			...
			{
			private PatientRecordManagement.Models.Doctor _record;
			private PatientRecordManagement.Models.Doctor _oldRecord;
            public Dictionary<string, object> FixedValues = new Dictionary<string, object>();

            public Func<PatientRecordManagement.Models.Doctor, PatientRecordManagement.Models.Doctor, bool> BeforeSave { get; set; } = null;
            public Action<PatientRecordManagement.Models.Doctor> AfterSave { get; set; } = null;

			public Frm_Doctor(Color themeColor,PatientRecordManagement.Models.Doctor record = null, bool readOnly = false)
			{
			...
			if(record==null)
			_record = new PatientRecordManagement.Models.Doctor(); //create new recoded
			else
            ...
            catch (Exception err)
            {
			  ...
			  private void Frm_Load(object sender, EventArgs e) 
			  {
					...
					if (this.FixedValues.Count() > 0)
					{
						...
						_record = tmp.ToObject<PatientRecordManagement.Models.Doctor>();
					}
