//Code Generated by Jenga.NET
			...
			public partial class ConsultingA : Form
			{
			...
			public ConsultingA(Color themeColor,PatientRecordManagement.Models.Visit record = null, bool readOnly = false)
			{
			...
			var db = Kt.Db;
			bunifuDropdownC1.DataSource=db.Select<PatientRecordManagement.Models.Doctor>();
//reference
