//Code Generated by Jenga.NET
			...
			public partial class FamPlanning : Form
			{
        ...
        public FamPlanning(Color themeColor,PatientRecordManagement.Models.Visit record = null, bool readOnly = false)
			{
			...
			var db = Kt.Db;
			bunifuDropdownFM1.DataSource=db.Select<PatientRecordManagement.Models.Doctor>();
//reference
