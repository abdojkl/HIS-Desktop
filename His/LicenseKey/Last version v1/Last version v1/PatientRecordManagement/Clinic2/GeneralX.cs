//Code Generated by Jenga.NET
			...
			public partial class GeneralX : Form
			{
        ...
        public GeneralX(Color themeColor,PatientRecordManagement.Models.Visit record = null, bool readOnly = false)
			{
			...
			var db = Kt.Db;
			bunifuDropdownG1.DataSource=db.Select<PatientRecordManagement.Models.Doctor>();
//reference
