//Code Generated by Jenga.NET
			...
			public partial class Awarnes : Form
			{
			...
			public Awarnes(Color themeColor,PatientRecordManagement.Models.Visit record = null, bool readOnly = false)
			{
			...
			var db = Kt.Db;
			bunifuDropdownAW1.DataSource=db.Select<PatientRecordManagement.Models.Doctor>();
//reference
