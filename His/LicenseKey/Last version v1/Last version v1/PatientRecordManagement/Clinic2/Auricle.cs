//Code Generated by Jenga.NET
			...
			public partial class Auricle : Form
			{
        ...
        public Auricle(Color themeColor,PatientRecordManagement.Models.Visit record = null, bool readOnly = false)
			{
			...
			var db = Kt.Db;
			bunifuDropdownAC1.DataSource=db.Select<PatientRecordManagement.Models.Doctor>();
//reference
