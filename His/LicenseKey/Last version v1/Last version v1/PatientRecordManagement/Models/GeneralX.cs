...
namespace PatientRecordManagement.Models
{
    ...
    public class GeneralX
    {
        ...
        public int NVisitG { get; set; }
        public string ReseanG { get; set; }
        public DateTime DateG { get; set; } = DateTime.Now;
        public string TSerProvideG { get; set; }
        public string NSerProvideG { get; set; }

        public string GeneralClassification { get; set; }
        public string RespiratoryComp { get; set; }
        public string ENeurologicalComp { get; set; }
        public string BonesJoints { get; set; }
        public string TestsG { get; set; }
