...
namespace PatientRecordManagement.Models
{
    ...
    public class FamPlanning
    {
        ...
        public int NVisitAFP { get; set; }
        public DateTime DateFP { get; set; } = DateTime.Now;
        public string TSerProvideFP { get; set; }
        public string NSerProvideAFP{ get; set; }

        public string Pregnancy { get; set; }
        public string CurrentComp { get; set; }
        public string PreviouslyUsed { get; set; }
        public string HowToUse { get; set; }
        public string CompleteFP { get; set; }
        public string MedicineFP { get; set; }
