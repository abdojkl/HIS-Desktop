...
namespace PatientRecordManagement.Models
{
    ...
    public class ANC
    {
        ...
        public int NVisitAN { get; set; }
        public DateTime DateAN { get; set; } = DateTime.Now;
        public string TSerProvideAN { get; set; }
        public string NSerProvideAN{ get; set; }

        public string CurrentComp { get; set; }
        public string TestAN { get; set; }
        public string Echo { get; set; }
        public string PreType { get; set; }
        public string ReasonRP { get; set; }
        public string MedicineAN { get; set; }
